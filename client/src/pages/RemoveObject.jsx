import { ScanIcon, Scissors, Sparkles } from 'lucide-react'
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='mt-2 text-sm font-medium'>Describe object name to remove.</p>
        ...
        <textarea
          ...
          placeholder='e.g., watch or spoon, Oly single object name'
          required
        />
